...
try {
  ...
  if (urlLang && (LANGS as Record<string, string>)[urlLang]) currentLang = urlLang as LangCode;
  else currentLang = (localStorage.getItem('team_exam_lang') as LangCode) || 'en';
} catch (e) { /* ignore */ }
if (!LANGS[currentLang]) currentLang = 'en';

export function getCurrentLang(): LangCode { return currentLang; }
export function setCurrentLang(lang: LangCode): void { currentLang = lang; }
...
export const I18N: Record<LangCode, Record<string, string>> = {
  "en": {
    ...
    "hero_sub": "Take your Mathematics or English examination online. Please register your details and select your preferred exam to begin.",
    ...
    "exam_math_desc": "30 multiple choice questions &bull; 120 minutes",
    ...
    "exam_eng_desc": "Use of English, Reading &amp; Writing &bull; 150 minutes",
    ...
    "info_duration": "Mathematics: 120 minutes<br>English: 150 minutes<br>Timer starts when you begin.",
    "info_types_t": "Question Types",
    "info_types": "Mathematics: Multiple Choice (30)<br>English: Grammar, Word Bank, Reading, Short Answer, T/F/Not Given",
    "info_rules_t": "Exam Rules",
    "info_rules": "Be on time. No cheating devices.<br>No tab switching. Your answers are saved automatically. Submit before time expires.",
    ...
    "footer_contact_info": "Phone: +998 78 113 08 28<br>Email: admission@teamuni.uz",
    "footer_tagline": "The first private entrepreneurial university in Uzbekistan.",
    ...
    "waiting_note": "Please return on your scheduled exam date to take the examination.",
    "btn_back_home": "Back to Home",
    "taken_title": "Exam Already Taken",
    "taken_text": "You have already taken this exam. Each student is allowed only one attempt.",
    ...
    "btn_flagged": "Flagged",
    "kbd_hint": "Keyboard: 1-4 to answer | &#8592; &#8594; to navigate | F to flag | S for next",
    "btn_exit": "Exit",
    ...
    "results_sub": "Thank you for completing your examination. Your answers have been recorded.",
    ...
    "results_next1": "Your exam will be reviewed by our academic team within 5 working days.",
    "results_next2": "You will receive your results via email at the address provided during registration.",
    "results_next3": "For any questions, contact us at info@teamuni.uz or +998 78 150 00 00.",
    "btn_return_home": "Return to Home",
    "dq_title": "Exam Disqualified",
    "dq_text": "You have been disqualified from this examination for switching windows/tabs too many times. This is considered a violation of exam rules.",
    "dq_status": "Status",
    "dq_reason": "Reason",
    ...
    "review_banner": "{a} of {t} questions answered &#8226; {f} flagged for review",
    "dc_0716": "Jul 16",
    "dc_0724": "Jul 24",
    "dc_0803": "Aug 3",
    "dc_0816": "Aug 16"
  ...
  "uz": {
    ...
    "hero_sub": "Matematika yoki ingliz tili imtihonini onlayn topshiring. Boshlash uchun ma'lumotlaringizni kiriting va o'zingizga mos imtihonni tanlang.",
    ...
    "exam_math_desc": "30 ta test savoli &bull; 120 daqiqa",
    ...
    "exam_eng_desc": "Use of English, Reading &amp; Writing &bull; 150 daqiqa",
    ...
    "info_sub": "Imtihon topshirishdan oldin bilishingiz kerak bo'lgan hamma narsa",
    "info_duration_t": "Imtihon davomiyligi",
    "info_duration": "Matematika: 120 daqiqa<br>Ingliz tili: 150 daqiqa<br>Taymer imtihonni boshlaganingizda ishga tushadi.",
    "info_types_t": "Savol turlari",
    "info_types": "Matematika: Test savollari (30)<br>Ingliz tili: Grammar, Word Bank, Reading, Short Answer, T/F/Not Given",
    "info_rules_t": "Imtihon qoidalari",
    "info_rules": "O'z vaqtida keling. Yordamchi vositalar taqiqlanadi.<br>Boshqa vkladkalarga o'tmang. Javoblaringiz avtomatik saqlanadi. Vaqt tugashidan oldin topshiring.",
    ...
    "footer_contact_info": "Telefon: +998 78 113 08 28<br>El. pochta: admission@teamuni.uz",
    ...
    "waiting_note": "Imtihonni topshirish uchun belgilangan sanada qaytib keling.",
    "btn_back_home": "Bosh sahifaga qaytish",
    "taken_title": "Imtihon allaqachon topshirilgan",
    "taken_text": "Siz bu imtihonni allaqachon topshirgansiz. Har bir talabaga faqat bitta urinish beriladi.",
    ...
    "kbd_hint": "Klaviatura: javob uchun 1-4 | harakat uchun &#8592; &#8594; | belgilash uchun F | keyingisi uchun S",
    "btn_exit": "Chiqish",
    ...
    "results_sub": "Imtihonni yakunlaganingiz uchun rahmat. Javoblaringiz qayd etildi.",
    ...
    "results_next1": "Imtihoningiz akademik jamoamiz tomonidan 5 ish kuni ichida ko'rib chiqiladi.",
    "results_next2": "Natijalaringiz ro'yxatdan o'tishda ko'rsatilgan elektron pochtangizga yuboriladi.",
    "results_next3": "Savollar bo'lsa, info@teamuni.uz manziliga yozing yoki +998 78 150 00 00 raqamiga qo'ng'iroq qiling.",
    "btn_return_home": "Bosh sahifaga qaytish",
    "dq_title": "Imtihondan chetlatildingiz",
    "dq_text": "Siz oynalarni/vkladkalarni juda ko'p almashtirganingiz uchun imtihondan chetlatildingiz. Bu imtihon qoidalarini buzish hisoblanadi.",
    "dq_status": "Holat",
    "dq_reason": "Sabab",
    ...
    "submit_confirm": "Imtihonni topshirasizmi? Bu amalni ortga qaytarib bo'lmaydi.",
    ...
    "review_banner": "{t} tadan {a} ta savolga javob berildi &#8226; {f} ta belgilangan",
    "dc_0716": "16-iyul",
    "dc_0724": "24-iyul",
    "dc_0803": "3-avgust",
    "dc_0816": "16-avgust"
  ...
  "ru": {
    ...
    "hero_sub": "Сдайте экзамен по математике или английскому языку онлайн. Чтобы начать, заполните свои данные и выберите экзамен.",
    ...
    "exam_math_desc": "30 тестовых вопросов &bull; 120 минут",
    ...
    "exam_eng_desc": "Use of English, Reading &amp; Writing &bull; 150 минут",
    ...
    "info_duration": "Математика: 120 минут<br>Английский: 150 минут<br>Таймер запускается в начале экзамена.",
    "info_types_t": "Типы вопросов",
    "info_types": "Математика: Тестовые вопросы (30)<br>Английский: Grammar, Word Bank, Reading, Short Answer, T/F/Not Given",
    "info_rules_t": "Правила экзамена",
    "info_rules": "Приходите вовремя. Шпаргалки и устройства запрещены.<br>Не переключайте вкладки. Ответы сохраняются автоматически. Отправьте работу до окончания времени.",
    ...
    "footer_contact_info": "Телефон: +998 78 113 08 28<br>Эл. почта: admission@teamuni.uz",
    "footer_tagline": "Первый частный предпринимательский университет в Узбекистане.",
    ...
    "waiting_note": "Пожалуйста, вернитесь в назначенную дату, чтобы сдать экзамен.",
    "btn_back_home": "На главную",
    "taken_title": "Экзамен уже сдан",
    "taken_text": "Вы уже сдали этот экзамен. Каждому студенту разрешена только одна попытка.",
    ...
    "kbd_hint": "Клавиатура: 1-4 для ответа | &#8592; &#8594; навигация | F — отметить | S — далее",
    "btn_exit": "Выход",
    ...
    "results_next1": "Ваш экзамен будет проверен нашей академической командой в течение 5 рабочих дней.",
    "results_next2": "Вы получите результаты на электронную почту, указанную при регистрации.",
    "results_next3": "По любым вопросам пишите на info@teamuni.uz или звоните +998 78 150 00 00.",
    "btn_return_home": "Вернуться на главную",
    "dq_title": "Экзамен аннулирован",
    "dq_text": "Вы были отстранены от экзамена за многократное переключение окон/вкладок. Это считается нарушением правил экзамена.",
    "dq_status": "Статус",
    "dq_reason": "Причина",
...
export function getQText<T extends object>(q: T): string {
  ...
  if (currentLang !== 'en' && r['text_' + currentLang]) return r['text_' + currentLang] as string;
  return r.text as string;
}
export function getQOptions<T extends object>(q: T): string[] {
  const r = q as Record<string, unknown>;
  if (currentLang !== 'en' && r['options_' + currentLang]) return r['options_' + currentLang] as string[];
  return r.options as string[];
}
export function getSecTitle<T extends object>(s: T): string {
  const r = s as Record<string, unknown>;
  if (currentLang !== 'en' && r['title_' + currentLang]) return r['title_' + currentLang] as string;
  return r.title as string;
}
export function getDateLabel<T extends object>(fd: T): string {
  const r = fd as Record<string, unknown>;
  if (currentLang !== 'en' && r['label_' + currentLang]) return r['label_' + currentLang] as string;
...
export function i18nProps(key: string): { 'data-i18n': string; dangerouslySetInnerHTML: { __html: string } } {
  return { 'data-i18n': key, dangerouslySetInnerHTML: { __html: t(key) } };
}
export function i18nPhProps(key: string): { 'data-i18n-ph': string; placeholder: string } {
